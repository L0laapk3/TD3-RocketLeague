...
namespace SuperSonicML::Plugin {
	...
	void SuperSonicMLPlugin::onLoad() {
		...
		this->cvarManager->registerCvar("supersonicml_slide_enabled", "1", "Enable/Disable slide", true, true, 0.f, true, 1.f).bindTo(SuperSonicML::Share::cvarEnableSlide);
		this->cvarManager->registerCvar("supersonicml_batch_size", "4", "", true, true, 1, true, 16).bindTo(SuperSonicML::Share::cvarBatchSize);
		this->cvarManager->registerCvar("supersonicml_training_enabled", "0", "Enable/Disable training", true, true, 0.f, true, 1.f).bindTo(SuperSonicML::Share::cvarEnableTraining);
